...
var dictionary_stats = {"Int": array_int, "War": array_war, "Charm": array_charm};
...
function setup_data(){
    array_data_general.forEach(object_general => {
        array_int.push(object_general.Int);
        array_war.push(object_general.War);
        array_charm.push(object_general.Charm);
        array_name.push(object_general.General);
    });
...
function draw(){
    ...
    context.save();
        ...
        plot_scatter(array_int, array_charm, "RGBA(0, 0, 0, 0.5)");
        var function_of_best_fit = make_function_of_best_fit(dictionary_stats[x_axis], dictionary_stats[y_axis]);
        plot_function(function_of_best_fit, "Grey", 3);

        draw_array_general(["Liu Bei", "Cao Cao", "Sun Quan", "Liu Biao", "Yuan Shao", "Yuan Shu", "Dong Zhuo", "Lu Bu", "Gongsun Zan", "Tao Quian", "Zhang Xiu", "Zhuge Liang", "Ma Teng", "Zhang Lu", "Liu Zhang"], x_axis, y_axis);
...
function draw_array_general(a_array_name, stats_x="Int", stats_y="Charm"){
